...
int main() 
{
    ...
    std::cout<<"*****************************************************"<<std::endl;
    entry.user("me").to("Elog","Demo").receiveEntry("last");
    entry.print();
    ...
    entry4.user("me").to("Elog","Demo").send("V");
    entry4.print();
    ...
    entry2.user("me").to("Elog","Demo").replyTo("last").send();
    entry2.print();
    ...
    entry3.user("me").to("Elog","Demo").receiveEntry("last");
    entry3.print();
