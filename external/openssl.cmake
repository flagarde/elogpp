...
if(COMPILE_OPENSSL)
  if(NOT TARGET openssl_project)
    ...
    externalproject_add(
      ...
      GIT_PROGRESS TRUE
      GIT_SHALLOW TRUE
      CMAKE_ARGS -DCMAKE_BUILD_TYPE=${CMAKE_BUILD_TYPE} -DCMAKE_INSTALL_PREFIX=${CMAKE_INSTALL_PREFIX} -DCMAKE_CXX_STANDARD=${CMAKE_CXX_STANDARD} -DCMAKE_CXX_STANDARD_REQUIRED=${CMAKE_CXX_STANDARD_REQUIRED}
                 -DCMAKE_CXX_EXTENSIONS=${CMAKE_CXX_EXTENSIONS} -DCMAKE_POSITION_INDEPENDENT_CODE=${CMAKE_POSITION_INDEPENDENT_CODE} -DWITH_APPS=OFF
    ...
    # find_package(OpenSSL) may not have found it, clear parent scope variables set to NOTFOUND
